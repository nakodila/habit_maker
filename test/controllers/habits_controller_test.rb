...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { color: @habit.color, description: @habit.description, duration: @habit.duration, name: @habit.name } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { color: @habit.color, description: @habit.description, duration: @habit.duration, name: @habit.name } }
